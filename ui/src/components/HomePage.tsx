...
const sgnlpHomePage = () => {
  return (
    <MainPage>
      ...
      <Paragraph>
        These models are also available in our sgnlp Python package.
        Please use <code>pip install sgnlp</code> to install the package.
      ...
      <Paragraph>
        Please note that the use of each model in the <code>sgnlp</code>{" "}
